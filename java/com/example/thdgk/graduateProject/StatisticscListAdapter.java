...
public class StatisticscListAdapter extends BaseAdapter {
    ...
    public StatisticscListAdapter(Context context, List<Course> courseList, Fragment parent) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                        ...
                        try {
                            ...
                            if (success) {
                                ...
                                AlertDialog dialog = builder.setMessage("강의가 삭제 되었습니다.")
                                        ...
                                        .create();
                                dialog.show();
                                StaticsFragment.totalCredit -= courseList.get(i).getCourseCredit();
                ...
                Log.w("deleteTest1", userID);
                Log.w("deleteTest2", courseList.get(i).getCourseID()+"");
                DeleteRequest delegeRequest = new DeleteRequest(userID, courseList.get(i).getCourseID()+"", responseListener);
                RequestQueue queue = Volley.newRequestQueue(parent.getActivity());
                queue.add(delegeRequest);
                }
        });
