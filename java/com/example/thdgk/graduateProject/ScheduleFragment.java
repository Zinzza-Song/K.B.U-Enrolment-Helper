...
public class ScheduleFragment extends Fragment {
    ...
    private AutoResizeTextView monday[] = new AutoResizeTextView[6];
    private AutoResizeTextView tuesday[] = new AutoResizeTextView[6];
    private AutoResizeTextView wednesday[] = new AutoResizeTextView[6];
    private AutoResizeTextView thursday[] = new AutoResizeTextView[6];
    private AutoResizeTextView friday[] = new AutoResizeTextView[6];
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute(){
            try{
                target = "http://192.168.17.1:8080/ScheduleList.php?userID=" + URLEncoder.encode(MainActivity.userID, "UTF-8");
            }
            catch (Exception e){
                e.printStackTrace();
            }
